...
@extend_schema(
    ...
    description=(
        ...
        '**curl GET example:**\n'
        '```bash\n'
        'curl "https://cf89615f228bb45cc805447510de80.pythonanywhere.com/api/v1/blog/"\n'
        '```'
    ),
    parameters=[
...
@extend_schema(
    ...
    description=(
        ...
        '**curl GET example:**\n'
        '```bash\n'
        'curl https://cf89615f228bb45cc805447510de80.pythonanywhere.com/api/v1/blog/best-time-to-visit-serengeti/\n'
        '```'
    ),
    responses={
