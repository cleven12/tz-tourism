...
@extend_schema(
    ...
    description=(
        ...
        '**curl example:**\n'
        '```bash\n'
        'curl https://159.65.119.182:8000/api/v1/weather/\n'
        '```'
    ),
    responses={
        200: OpenApiResponse(
...
@extend_schema(
    ...
    description=(
        ...
        '**curl example:**\n'
        '```bash\n'
        'curl https://159.65.119.182:8000/api/v1/weather/1/\n'
        '```'
    ),
    responses={
        200: OpenApiResponse(
...
@extend_schema(
    ...
    description=(
        ...
        '```bash\n'
        'curl "https://159.65.119.182:8000/api/v1/weather/current/?lat=-3.0674&lon=37.3556"\n'
        '```\n\n'
        '**curl example (by attraction slug):**\n'
        '```bash\n'
        'curl "https://159.65.119.182:8000/api/v1/weather/current/?attraction=mount-kilimanjaro"\n'
        '```'
    ),
    parameters=[
...
@extend_schema(
    ...
    description=(
        ...
        '```bash\n'
        'curl "https://159.65.119.182:8000/api/v1/weather/forecast/?attraction=mount-kilimanjaro&days=7"\n'
        '```\n\n'
        '**curl example (3-day forecast by coordinates):**\n'
        '```bash\n'
        'curl "https://159.65.119.182:8000/api/v1/weather/forecast/?lat=-3.0674&lon=37.3556&days=3"\n'
        '```'
    ),
    parameters=[
...
@extend_schema(
    ...
    description=(
        ...
        '**curl example:**\n'
        '```bash\n'
        'curl "https://159.65.119.182:8000/api/v1/weather/seasonal/?attraction=mount-kilimanjaro"\n'
        '```'
    ),
    parameters=[
        OpenApiParameter(
