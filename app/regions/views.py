...
@extend_schema(
    ...
    description=(
        ...
        '**curl GET example:**\n'
        '```bash\n'
        'curl https://cf89615f228bb45cc805447510de80.pythonanywhere.com/api/v1/regions/\n'
        '```\n\n'
        '**curl POST example:**\n'
        '```bash\n'
        'curl -X POST https://cf89615f228bb45cc805447510de80.pythonanywhere.com/api/v1/regions/ \\\n'
...
@extend_schema(
    ...
    description=(
        ...
        '**curl GET example:**\n'
        '```bash\n'
        'curl https://cf89615f228bb45cc805447510de80.pythonanywhere.com/api/v1/regions/arusha/\n'
        '```\n\n'
        '**curl PATCH example:**\n'
        '```bash\n'
        'curl -X PATCH https://cf89615f228bb45cc805447510de80.pythonanywhere.com/api/v1/regions/arusha/ \\\n'
        '  -H "Authorization: Bearer <access_token>" \\\n'
        '  -H "Content-Type: application/json" \\\n'
