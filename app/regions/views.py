...
@extend_schema(
    ...
    description=(
        ...
        '**curl GET example:**\n'
        '```bash\n'
        'curl https://159.65.119.182:8000/api/v1/regions/\n'
        '```\n\n'
        '**curl POST example:**\n'
        '```bash\n'
        'curl -X POST https://159.65.119.182:8000/api/v1/regions/ \\\n'
...
@extend_schema(
    ...
    description=(
        ...
        '**curl GET example:**\n'
        '```bash\n'
        'curl https://159.65.119.182:8000/api/v1/regions/arusha/\n'
        '```\n\n'
        '**curl PATCH example:**\n'
        '```bash\n'
        'curl -X PATCH https://159.65.119.182:8000/api/v1/regions/arusha/ \\\n'
        '  -H "Authorization: Bearer <access_token>" \\\n'
        '  -H "Content-Type: application/json" \\\n'
