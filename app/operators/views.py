...
@extend_schema(
    ...
    description=(
        ...
        '**curl GET example:**\n'
        '```bash\n'
        'curl "https://159.65.119.182:8000/api/v1/operators/"\n'
        '```'
    ),
    parameters=[
...
@extend_schema(
    ...
    description=(
        ...
        '**curl GET example:**\n'
        '```bash\n'
        'curl https://159.65.119.182:8000/api/v1/operators/serengeti-adventures/\n'
        '```'
    ),
    responses={
...
@extend_schema(
    ...
    description=(
        ...
        '**curl example:**\n'
        '```bash\n'
        'curl "https://159.65.119.182:8000/api/v1/operators/by_attraction/?attraction=mount-kilimanjaro"\n'
        '```'
    ),
    parameters=[
        OpenApiParameter(
