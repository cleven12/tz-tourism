...
@extend_schema(
    ...
    description=(
        ...
        '**curl example:**\n'
        '```bash\n'
        'curl -X POST https://159.65.119.182:8000/api/v1/auth/register/ \\\n'
...
@extend_schema(
    ...
    description=(
        ...
        '**curl example:**\n'
        '```bash\n'
        'curl -X POST https://159.65.119.182:8000/api/v1/auth/login/ \\\n'
        '  -H "Content-Type: application/json" \\\n'
...
@extend_schema(
    ...
    description=(
        ...
        '**curl example (GET):**\n'
        '```bash\n'
        'curl https://159.65.119.182:8000/api/v1/auth/profile/ \\\n'
        '  -H "Authorization: Bearer <access_token>"\n'
        '```\n\n'
        '**curl example (PATCH):**\n'
        '```bash\n'
        'curl -X PATCH https://159.65.119.182:8000/api/v1/auth/profile/ \\\n'
        '  -H "Authorization: Bearer <access_token>" \\\n'
        '  -H "Content-Type: application/json" \\\n'
        '  -d \'{"bio":"Updated bio"}\'\n'
        '```'
